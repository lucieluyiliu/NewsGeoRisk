...
cp Output/[task]/figure.png Notes/WorkingJournal/attachments/YYYY-MM-DD-description.png
```
...
Source: [Original](../../Output/[task]/figure.png)
```
...
author: "[[Lucie]]"
date: YYYY-MM-DD
project: "[[News-based Geoeconomic Risk]]"
...
**Good (Factual):**
- "Estimated conditional premia for 41 countries, 2000-2023"
- "Difference of -0.8pp relative to the unconditional estimate"
- "Bootstrap CI covers zero for 12 of 41 countries"

**Bad (Speculative/Interpretive):**
- "This suggests the decomposition is unreliable"
- "The results indicate strong identification"
- "The excellent fit validates our approach"
